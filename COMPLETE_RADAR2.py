...
def setup():
  ...
  print("Setting detection range...")
  radar.set_detection_range(30, 2000, 2000)
  time.sleep(0.5)
  
  # set trigger sensitivity 0 - 9 (0 = most sensitive, 9 = least sensitive)
  print("Setting trigger sensitivity...")
  radar.set_trig_sensitivity(0)
  time.sleep(0.5)
  
  # set keep sensitivity 0 - 9 (0 = most sensitive, 9 = least sensitive)
